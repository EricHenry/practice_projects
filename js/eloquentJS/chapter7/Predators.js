...
function SmartPlantEater() {
    this.energy = 25;
    this.direction = "e";
    // this.hunger = 0; // once it reaches 10 the critter is hungry enough to eat
}

SmartPlantEater.prototype.act = function(view) {
    let space.find(" ");
    if (this.enery > 100 && space) {
        return { type: "reproduce", direction: space };
    }
...
Tiger.prototype.act = function(view) {
    ...
    if (view.look(this.direction) != " " && space) { // if the current direction is blocked and there is an open space. Continue change direction to that space;
        this.direction = space;
    }
    return { type: "move", direction: this.direction };
}

// Completed code by author
// function Tiger() {
//     this.energy = 100;
//     this.direction = "w";
