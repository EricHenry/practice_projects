...
public class CrimeActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //This fragment manager get call is for
        //  pre honeycomb compatability FragmentManager fManager = getSupportFragmentManager();
        FragmentManager fManager = getSupportFragmentManager();

        //give a fragment to fragment manager. This is becuase it needs something to manage
